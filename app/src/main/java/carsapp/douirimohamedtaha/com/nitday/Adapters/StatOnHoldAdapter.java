...
public class StatOnHoldAdapter extends RecyclerView.Adapter<StatOnHoldAdapter.ViewHolder> {
    ...
    public StatOnHoldAdapter(List<Ticket> items, Context context) {
        this.items = items;
        this.mContext = context;
    }

    @Override
    public StatOnHoldAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.one_item_on_hold, parent, false);
        return new StatOnHoldAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(StatOnHoldAdapter.ViewHolder holder, int position) {
        ...
        holder.image.setOnClickListener(view -> {
            Log.d("State","Touched "+item.getLat());
        });
    }
